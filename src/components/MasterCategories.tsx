  ...
  return <section className="py-20 bg-gradient-to-b from-background via-muted/20 to-background relative overflow-hidden z-0">
      ...
      <div className="container mx-auto px-4 lg:px-8 relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16 animate-fade-up">
          ...
          <h2 className="font-bebas text-3xl md:text-5xl font-bold bg-gradient-to-r from-foreground via-primary to-secondary bg-clip-text text-transparent mb-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8 max-w-6xl mx-auto">
          ...
          animationDelay: `${index * 0.15}s`
              ...
              <div className="relative text-center space-y-4">
                <h3 className="font-bebas text-xl font-bold text-foreground group-hover:text-primary transition-colors duration-300">
                  {school.title}
                </h3>
