        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8 max-w-6xl mx-auto">
          {schools.map((school, index) => (
            <Link
              key={school.id}
              to={`/school/${school.id}`}
              className="relative bg-card rounded-3xl border border-border/50 p-8 cursor-pointer overflow-hidden group animate-fade-up hover:border-primary/50 transition-all duration-500"
