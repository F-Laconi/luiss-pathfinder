    ...
    <footer className="bg-foreground text-background">
      <div className="container mx-auto px-4 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          {/* Quick Links */}
          <div className="space-y-4">
            <h3 className="font-nunito font-semibold text-lg uppercase">Quick Links</h3>
          ...
          {/* Support */}
          <div className="space-y-4">
            <h3 className="font-nunito font-semibold text-lg uppercase">Support</h3>
            <div className="space-y-2">
          ...
          {/* Contact Info */}
          <div className="space-y-4">
            <h3 className="font-nunito font-semibold text-lg uppercase">Contact</h3>
