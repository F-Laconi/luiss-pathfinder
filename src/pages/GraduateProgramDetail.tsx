    ...
    return (
      <div className="min-h-screen bg-background">
        ...
        <div className="container mx-auto px-4 py-24 text-center">
          <h1 className="font-bebas text-3xl font-bold mb-4">Program Not Found</h1>
          <Link to="/graduate">
      ...
      <section className="pt-24 pb-12 bg-gradient-to-br from-primary/10 via-purple-500/5 to-background relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 lg:px-8 relative">
          ...
          <div className="max-w-4xl">
            ...
            <h1 className="font-bebas text-4xl md:text-5xl font-bold text-foreground mb-6 animate-fade-up">
              {program.title}
            </h1>
          ...
          <Tabs defaultValue="curriculum" className="w-full">
            ...
            <TabsContent value="curriculum" className="space-y-6">
              <div className="text-center mb-8">
                <h2 className="font-bebas text-3xl font-bold mb-4">Complete Curriculum</h2>
            ...
            <TabsContent value="structure" className="space-y-6">
              <div className="max-w-4xl mx-auto">
                <h2 className="font-bebas text-3xl font-bold mb-8 text-center">Program Structure</h2>
