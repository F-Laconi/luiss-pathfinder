        ...
        <div className="relative overflow-hidden">
          ...
          <div className="container mx-auto px-4 lg:px-8 py-20">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <h1 className="font-nunito uppercase text-5xl md:text-7xl font-bold text-foreground mb-6 animate-fade-in">
                About
          ...
          <div className="max-w-6xl mx-auto">
            <div className="grid lg:grid-cols-2 gap-12 items-center mb-20">
              <div className="space-y-6">
                ...
                <h2 className="font-nunito uppercase text-4xl font-bold text-foreground leading-tight">
                  Seven dreamers,
            ...
            <div className="relative">
              ...
              <div className="relative bg-card/50 backdrop-blur-sm border border-border/20 rounded-3xl p-12">
                <div className="text-center mb-12">
                  ...
                  <h2 className="font-nunito uppercase text-4xl font-bold text-foreground mb-6">
                ...
                <div className="grid md:grid-cols-3 gap-8">
                  <div className="text-center p-6 rounded-2xl bg-gradient-to-br from-primary/10 to-primary/5 border border-primary/20">
                    ...
                    <h3 className="font-nunito uppercase text-xl font-semibold text-foreground mb-3">Clear Guidance</h3>
                  ...
                  <div className="text-center p-6 rounded-2xl bg-gradient-to-br from-accent/10 to-accent/5 border border-accent/20">
                    ...
                    <h3 className="font-nunito uppercase text-xl font-semibold text-foreground mb-3">Connect & Collaborate</h3>
                  ...
                  <div className="text-center p-6 rounded-2xl bg-gradient-to-br from-secondary/10 to-secondary/5 border border-secondary/20">
                    ...
                    <h3 className="font-nunito uppercase text-xl font-semibold text-foreground mb-3">Launch Your Future</h3>
