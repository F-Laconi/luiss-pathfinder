      ...
      <article className="container max-w-5xl mx-auto px-4 sm:px-6 text-center relative z-40">
        ...
        <header className="mb-12 sm:mb-20 animate-fade-up">
          <div className="relative inline-block">
            <h1 className="font-bebas text-5xl sm:text-6xl md:text-8xl lg:text-9xl font-bold bg-gradient-to-r from-blue-900 via-blue-800 to-blue-900 bg-clip-text text-transparent mb-4 sm:mb-6 relative mt-16 sm:mt-20 px-2">
              UniCompass
            </h1>
        ...
        <nav className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8 md:gap-12 max-w-3xl mx-auto px-4 animate-fade-up" style={{ animationDelay: '0.3s' }} aria-label="Main navigation options">
          ...
          >
            <div className="flex flex-col items-center space-y-6">
              ...
              <div className="space-y-2">
                <h2 className="font-bebas text-xl md:text-2xl font-bold text-foreground group-hover:text-primary transition-colors duration-300">
                  Make the Right Choice
                </h2>
          ...
          >
            <div className="flex flex-col items-center space-y-6">
              ...
              <div className="space-y-2">
                <h2 className="font-bebas text-xl md:text-2xl font-bold text-foreground group-hover:text-accent transition-colors duration-300">
                  Find Your Business Partner
                </h2>
                <p className="text-sm md:text-base text-muted-foreground group-hover:text-foreground/80 transition-colors">
