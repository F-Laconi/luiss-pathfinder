...
const Index = () => {
  return (
    <main>
      ...
      style={{
        backgroundImage: `linear-gradient(rgba(255, 255, 255, 0.3), rgba(255, 255, 255, 0.3)), url(${compassWallpaper})`,
      ...
      <article className="container max-w-5xl mx-auto px-4 sm:px-6 text-center relative z-40">
        ...
        <header className="mb-12 sm:mb-20 animate-fade-up">
          <div className="relative inline-block">
            <div className="absolute inset-0 bg-black/20 blur-2xl -inset-x-8 -inset-y-6"></div>
            ...
            <p className="text-base sm:text-lg md:text-xl text-muted-foreground font-medium opacity-80 px-4 relative">
