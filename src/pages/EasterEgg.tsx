    ...
    <div className="min-h-screen bg-gradient-to-br from-primary/5 via-accent/5 to-secondary/5 overflow-hidden">
      ...
      <div className="relative container mx-auto px-4 lg:px-8 py-20">
        ...
        <div className="text-center mb-16 animate-fade-in">
          ...
          <h1 className="font-playfair text-6xl md:text-8xl font-bold mb-6 bg-gradient-to-r from-primary via-accent to-secondary bg-clip-text text-transparent animate-fade-in">
            The Real Deal
          </h1>
