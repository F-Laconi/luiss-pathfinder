...
const GraduateSchool = () => {
  ...
  const suggestions = searchQuery.length > 0
    ? graduatePrograms.filter(program => 
          ...
          <div className="max-w-6xl mx-auto">
            <div className="flex flex-col lg:flex-row gap-6 items-stretch">
              ...
              <div className="relative flex-1">
                <Search className="absolute left-5 top-1/2 -translate-y-1/2 h-5 w-5 text-secondary/60 z-10" />
                <Input
                  type="text"
                  ...
                  <div className="absolute top-full mt-2 left-0 right-0 glass rounded-2xl border border-border/50 shadow-[var(--shadow-lg)] overflow-hidden z-50 animate-fade-in">
                    {suggestions.map((program) => (
                      <Link
                        ...
                        className="flex items-center gap-4 px-5 py-4 hover:bg-secondary/5 transition-colors duration-200 border-b border-border/30 last:border-b-0"
                      >
                  ...
                  <Card className="h-full card-glass overflow-hidden group-hover:shadow-[var(--shadow-glow)]">
                    <CardHeader className="p-0">
                      <div className="relative h-56 overflow-hidden">
                        ...
                        <Badge className="absolute top-6 right-6 bg-gradient-to-r from-secondary to-primary text-white border-0 shadow-xl font-semibold px-4 py-1.5 text-xs">
                          {program.category}
                        </Badge>
                      </div>
                    </CardHeader>
